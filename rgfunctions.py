...
def readrgvars(g, name = 'rgvar.dat'):
  """
  DEPRECATED
  function that reads back in the rgvars out of an rergvar.dat or imrgvar.dat file generated by 
  the old output format of generating_datak 
  """
  imfn = 'im'+name
  refn = 're'+name
  ref = open(refn,'r')
...
def readrgvarsplote(afhvar, npair , name = 'plotenergy.dat'):
  """
